...
a = Analysis(
    ['client.py', 'mdns_connect.py','updater.py','developer_label.py'],
    pathex=[os.path.dirname(os.path.abspath(__name__))],
    binaries=[],
    datas=collect_data_files('tkinterdnd2') + [(iconpath, 'Logo')],
    hiddenimports=['tkinterdnd2','requests','packaging','zeroconf', 'zeroconf._utils','zeroconf._utils.ipaddress', 'zeroconf._services', 'zeroconf._core', 'zeroconf._engine', 'zeroconf._listener','zeroconf._handlers.answers'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
